...
- Database for objects which use or inherit Unity libraries, integrated with a save system that allows writing such complex data types to disk outside of Unity’s systems.
...
- Baza danych obiektów korzystających i dziedziczących z bibliotek Unity sprzężona z systemem zapisu umożliwiające zapis takich złożonych typów danych na dysku poza systemami Unity.
