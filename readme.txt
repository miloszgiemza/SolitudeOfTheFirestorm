...
- GameController.cs - zarządza całą aplikacją
- GameplayController.cs - zarządza rozgrywką, na wzorcu maszyny stanów.
-Mechanika zapisu i wczytywanie postępu gracza obejmująca odblokowane poziomy, zaklęcia i zawartość ekwipunku
