...
{
    public class ButtonEquipedSpellsRemoveSlot : BaseButton
    {
        ...
        {
            wizardsWorkshopManager.SpellsManagementController.DiscardSpellSlotFromEquipedSpellsList(PlayerPersistentDataLoadedAndUnpackedController.Instance.PlayerPersistentData.PlayerUnlockedSpells,
