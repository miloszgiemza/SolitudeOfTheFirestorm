...
public class Tile
{
    ...
    public void MakeObjectsOnTileReact(BaseSpell spell, int modifierDamage, int modifierRange, int modifierEffectLength)
    {
        if (!ReferenceEquals(collectableItemSocket, null))
        {
            collectableItemSocket.ReactToSpell(spell, modifierDamage, modifierEffectLength);
        }
        if (!ReferenceEquals(enemySocket, null))
        {
            enemySocket.ReactToSpell(spell, modifierDamage, modifierEffectLength);
        }
        if(!ReferenceEquals(enemyFLyingSocket, null))
        {
            enemyFLyingSocket.ReactToSpell(spell, modifierDamage, modifierEffectLength);
        }
