...
public class LevelEnemiesPresetGenerator : MonoBehaviour
{
    ...
    private Dictionary<EnemyTier, List<EnemyDataAndStats>> enemiesAvaliableFromEachTier = new Dictionary<EnemyTier, List<EnemyDataAndStats>>();
    ...
    private void GroupEnemiesByTierAndAddToDcitionary(CountOfEnemiesOfTier[] countOfEnemiesOfTier, Dictionary<EnemyTier, List<EnemyDataAndStats>> enemiesAvaliableFromEachTier, EnemyDataAndStats[] avaliableEnemiesTypes)
    {
        for (int i = 0; i < countOfEnemiesOfTier.Length; i++)
        {
            if (!enemiesAvaliableFromEachTier.ContainsKey(countOfEnemiesOfTier[i].Tier))
            {
                enemiesAvaliableFromEachTier.Add(countOfEnemiesOfTier[i].Tier, new List<EnemyDataAndStats>());
            }
        }
    ...
    private IEnumerator GenerateEnemyPool(Dictionary<EnemyTier, List<GameplayObject>> enemyPool, CountOfEnemiesOfTier[] countOfEnemiesOfTier, Dictionary<EnemyTier, List<EnemyDataAndStats>> enemiesAvaliableFromEachTier)
    {
    ...
    private IEnumerator GenerateLevelPreset(int mapWidth, EnemyDataAndStats[] avaliableEnemiesTypes, int minHorizontalSpacinBetweenEnemies, int maxHorizontalSpacingBeetwenEnemies, CountOfEnemiesOfTier[] countOfEnemiesOfTier)
    {
