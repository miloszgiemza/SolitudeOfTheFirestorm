...
public class StateCastingSpellFromBigScrollInDebugMode : BasePlayerState
{
    public override PlayerState State => PlayerState.CastingSpellFromBigScrollDebugMode;
