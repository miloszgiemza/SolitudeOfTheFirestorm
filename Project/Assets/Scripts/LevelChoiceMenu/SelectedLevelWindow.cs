...
namespace LevelChoiceScene
{
    public class SelectedLevelWindow : MonoBehaviour
    {
        ...
        public void InitialzieWindow(EnemyDataAndStats[] levelEnemiesPreset, CountOfEnemiesOfTier[] countOfEnemiesOfTierPreset)
        {
            InitializeEnemiesInfos(levelEnemiesPreset, countOfEnemiesOfTierPreset);
            InitialzieTiersInfo(countOfEnemiesOfTierPreset);
        }

        private void InitializeEnemiesInfos(EnemyDataAndStats[] levelEnemiesPreset, CountOfEnemiesOfTier[] countOfEnemiesOfTierPreset)
        {
